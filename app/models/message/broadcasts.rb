module Message::Broadcasts
  ...
  private
    ...
    def broadcast_unread_room
      room.memberships.pluck(:user_id, :unread_count, :unread_mention_count).each do |user_id, unread_count, unread_mention_count|
        ActionCable.server.broadcast UnreadRoomsChannel.stream_name_for(user_id),
          { roomId: room.id, unreadCount: unread_count, unreadMentionCount: unread_mention_count }
      end
    end
end
